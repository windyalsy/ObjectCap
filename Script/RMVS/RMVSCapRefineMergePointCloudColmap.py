    ...
    try:
        ...
        if FinalMeshOpt:
            ...
            if MeshOpt:
                ...
                firstModel = os.path.join(meshFinalDir, "RecoverFinal_clean.obj")
                finalIterModel = os.path.join(meshFinalDir, "RecoverFinal_meshOpt.obj")
            ...
            if MeshOptSecond:
                ...
                reModel = os.path.join(OBJECT_Model_Dir_MERGE, "RecoverFinal_meshOpt.obj")
