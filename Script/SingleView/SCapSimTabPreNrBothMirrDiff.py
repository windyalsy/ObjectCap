...
if __name__ == "__main__":
    ...
    DATA_ROOT = r"D:\v-jiazha\4-projects\5-LED\2-Source"
    ...
    try:
        ...
        BALL_TYPE = r"Mirror"
        OBJECT = BALL_TYPE
        OBJECT_ROOT = os.path.join(DATA_ROOT, r'RealCommon', OBJECT)

        modelDirectory =os.path.join(OBJECT_ROOT, "Model")
        modelFile = os.path.join(modelDirectory, MODEL_NAME)

        framesDirectory =os.path.join(OBJECT_ROOT,"Frames")
        configDirectory =os.path.join(COMMON_ROOT, "Setup","Config")
