...
if __name__ == "__main__":
    ...
    try:
        ...
        i = 0
        viewDirectory = os.path.join(OBJECT_ROOT, "Views", "View_%04d" % i)
        framesDirectory = os.path.join(viewDirectory, "Frames")
        configDirectory = os.path.join(COMMON_ROOT, "Setups", "Setup", "Config")
        viewConfigDirectory = os.path.join(COMMON_ROOT, "Setups", "Setup_%04d" % i, "Config")
        ...
        reMaskImgFile = os.path.join(framesDirectory, "nrmDMsk.pfm")
