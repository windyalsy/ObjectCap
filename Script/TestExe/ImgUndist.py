...
if __name__ == "__main__":
    ...
    try:
        ...
        inputDir = r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies\Views\View_0000\Frames"
        inputFile = os.path.join(inputDir, "result_c0001.pfm")
        outputFile = os.path.join(inputDir, "result_c0001_undist.pfm")
        re = subprocess.run(
            ["ImgUndistort","-cameraConfig="+cameraConfig, "-in=" + inputFile, "-out=" + outputFile], stdout=True, stderr=True, check=True)
