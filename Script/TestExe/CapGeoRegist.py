...
if __name__ == "__main__":
    ...
    try:
        ...
        nCount = "3"
        imgName = r"image%02d.jpg"
        geoRegistFile = os.path.join(SfM_ROOT,"geoRegist.txt")
        re = subprocess.run(
            ["CapGeoRegist", "-cameraExtrin=" + cameraExtrinsic, "-geoRegistFile=" + geoRegistFile,
             "-imgName=" + imgName,
             "-viewScale=" + viewScale, "-nCount=" + nCount],
