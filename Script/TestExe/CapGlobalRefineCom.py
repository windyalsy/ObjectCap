...
if __name__ == "__main__":
    ...
    viewPosDir = os.path.join(nrmRefineDirectory,"FramesCombine")
    viewNrmRDir = os.path.join(nrmRefineDirectory,"Iter","Iter_final")
    ...
    try:
        ...
        if CapGlobalRefineOpt:
            ...
            re = subprocess.run(
                ["CapGlobalRefineCom", "-modelFile=" + modelFile,
                 ...
                 "-viewNrmRDir=" + viewNrmRDir,
                 "-viewPosDir=" + viewPosDir,
