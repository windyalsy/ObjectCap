...
if __name__ == "__main__":
    ...
    try:
        ...
        viewRecNrmDir = os.path.join(nrmRefineDirectory, "FramesCombine")
        cleanPointCloudIterDir = os.path.join(viewRecNrmDir, "Clean","Iter")
        cleanPointCloudIterFrameDir = os.path.join(cleanPointCloudIterDir,"Frames")

        viewMaskImgFile = os.path.join(viewRecNrmDir, "mask.pfm")
        ...
        keyPointsUVFile = os.path.join(r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies\Recover\Model\FinalOpt", "keyPointsUV.txt")
        keyPointsPosFile = os.path.join(r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies\Recover\Model\FinalOpt", "keyPointsPos.txt")
        texPosImgFile = os.path.join(r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies\Recover\Model\FinalOpt", "TexPos.pfm")

        re = subprocess.run(
            ["CapCreateKeyPointsList","-keyPointsUVFile=" + keyPointsUVFile, "-keyPointsPosFile=" + keyPointsPosFile,
            "--flipZ","-texPosImgFile="+texPosImgFile],
            stdout=True, stderr=True, check=True)

        keyPointsUVFile = os.path.join(
            r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies2\Recover\Model\FinalOpt",
            "keyPointsUV.txt")
        keyPointsPosFile = os.path.join(
            r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies2\Recover\Model\FinalOpt",
            "keyPointsPos.txt")
        texPosImgFile = os.path.join(
            r"D:\v-jiazha\4-projects\5-LED\2-Source\4-MVS\Object\RealObject-cookies2\Recover\Model\FinalOpt",
            "TexPos.pfm")
